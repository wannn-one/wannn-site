...
const projectItem = ({title, backgroundImg, description, projectUrl}) => {
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-[#FFCFCF] rounded-xl p-4 group hover:bg-gradient-to-r from-[#ADFF26] to-gray-200">
